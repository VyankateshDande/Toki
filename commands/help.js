    ...
    execute(message, args, Discord){
        const help_embed = new Discord.MessageEmbed({
            ...
            fields: [
                ...
                {name:"<dog", value:"Provides a cute dog picture!"},
                {name:"<cat", value:"Provides a cute cat picture!"},
                {name:"<duck", value:"Provides a cute duck picture!"},
                {name:"<fox", value:"Provides a cute fox picture!"},
                {name:"<panda", value:"Provides a cute panda picture!"},
            ]
        })
